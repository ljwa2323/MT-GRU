...
class Mynet(nn.Module):
    def __init__(self, model_config):
        ...
        self.miss_aware = nn.Sequential( # Missing 感知
    ...
    def forward(self, inputs):
        ...
        for i1 in range(time_len):  # 沿着时间维度
            ...
            aware = self.miss_aware(m1[:, i1, :]) # 缺失感知率计算
            x1 = x1 * aware # 通过乘法进行缺失感知
...
if __name__ == "__main__":
    ...
    for epoch in range(args.start_epoch, args.start_epoch+Epoch):
        ...
        for i, (x, y, d, t, m1, m0) in enumerate(dataloader_tr):
            ...
            if count>=50: # 如果大于等于50次就下一轮 epoch
                continue
        ...
        with torch.no_grad():
            ...
            torch.save(model.state_dict(), "{}/new_model2/model_params/param-model3-ylabel{}-{}.pth".format(args.root, col,epoch + 1))
            print("模型已经保存在: {}/new_model2/model_params/param-model3-ylabel{}-{}.pth".format(args.root, col, epoch + 1))
