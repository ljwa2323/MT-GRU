...
if __name__ == "__main__":
    ...
    for epoch in range(args.start_epoch, args.start_epoch+Epoch):
        ...
        for i, (x, y, d, t, m1, m0) in enumerate(dataloader_tr):
            ...
            # model(x, d, m1)
            yhat, _, _ = model([x, d.to(device),  m0]) # -- output:  y, x, m
        ...
        with torch.no_grad():
            ...
            torch.save(model.state_dict(), "{}/new_model2/model_params/param-model2_3-ylabel{}-{}.pth".format(args.root, col,epoch + 1))
            print("模型已经保存在: {}/new_model2/model_params/param-model2_3-ylabel{}-{}.pth".format(args.root, col, epoch + 1))
